...
def run(args, verbose=False):
    ...
    if args.visdom:
        ...
        # )
        graph_name = 'BIR_brn{}_CIFAR100_1'.format(args.batch_replay)
...
if __name__ == '__main__':
    ...
    print('>> CIFAR100 batch_replay : {}'.format(args.batch_replay), BIR)
    
    torch.save(
        BIR, './store/CIFAR100/bir_brn{}.pth'.format(args.batch_replay)
    )